...
function TablePlayers21() {
  const [players, setPlayers] = useState([]);

  useEffect(() => {
    axios.get('http://localhost:8080/secured/data21',{ withCredentials: true }
    )
  ...
  return (
    <div>
      <h1 className='text-black text-center font-sans font-extrabold'>Player Data 2021</h1>
