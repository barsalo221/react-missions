...
export default function TablePlayers23() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/secured/data23',{ withCredentials: true })
      .then(response =>{ 
  ...
  return (
    <div>  
      ...
      <div className='bg-cyan-100 '>
            <h1 className="text-center mb-4 text-3xl font-extrabold  md:text-5xl lg:text-6xl p-16 "><span className="text-transparent font-sans bg-clip-text bg-gradient-to-r to-yellow-300 from-black">Pred - Sport </span> <span className="text-transparent font-sans bg-clip-text bg-gradient-to-r to-yellow-300 from-black">Players Stats 2023</span></h1>
