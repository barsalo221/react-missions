...
export default function TablePlayers22() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/secured/data22',{ withCredentials: true })
      .then(response =>{ 
  ...
  return (
    <div>  
      ...
      <div className='bg-cyan-100'>
            <h1 className="text-center mb-4 text-3xl font-extrabold  md:text-5xl lg:text-6xl"><span className="text-transparent font-sans bg-clip-text bg-gradient-to-r to-yellow-300 from-black">Pred - Sport </span> <span className="text-transparent font-sans bg-clip-text bg-gradient-to-r to-yellow-300 from-black">Players Stats 2022</span></h1>
