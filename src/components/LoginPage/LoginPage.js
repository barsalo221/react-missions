  ...
  return (
    <div>
      <div className="container mb-8 p-4">
        <h1>
          <img
            class="mr-16 w-40 h-40 max-w-2xl container "
            src={logo}
            alt="logo"
          />
          Pred - Sport
      ...
      <section className="dark:bg-gray-900 pr-96 container h-screen">
        <div className="flex flex-col items-center mx-auto md:h-screen lg:py-0 bg-transparent mb-28">
          <div className="Login w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 ml-72 ">
