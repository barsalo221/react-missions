...
const HomePage = () => {
  ...
  return (
    <div className='container rounded-bl-lg mt-40 bg-cyan-100 h-screen shadow' >
      <img class="object-fill h-48 w-48 bg-transparent " src = {logo}  alt="image description"/>
      ...
      <p className="text-lg font-bold text-cyan-300-400 lg:text-2xl dark:text-black">Here at Pred-Sport we focus on NBA players, statistics and predict the future statistics of players<br/> come in to try and be impressed.</p>
