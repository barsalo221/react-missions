...
const HomePage = () => {
  ...
  return (
    <div className='container rounded-bl-lg mt-40 bg-transparent flex' >
      ...
      <p className="text-lg font-normal text-blue-300 lg:text-2xl dark:text-black">Here at Pred-Sport we focus on NBA players, statistics and predict the future statistics of players<br/> come in to try and be impressed.</p>
